package net.oikmo.engine.gui.font.fontMeshCreator;
...
public class MetaFile {
	...
	private boolean processNextLine() {
		...
		for (String part : line.split(SPLITTER)) {
			...
			if (valuePairs.length == 2) {
				//System.out.println(valuePairs[0] + " " + valuePairs[1]);
	...
	private void openFile(String file) {
		try {
			InputStreamReader isr = new InputStreamReader(MetaFile.class.getResourceAsStream("/assets/fonts/" + file + ".fnt"));
			reader = new BufferedReader(isr);
		} catch (Exception e) {
			Main.error("Couldn't read font meta file!", e);
		}
	}
