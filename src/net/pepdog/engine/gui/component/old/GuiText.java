...
public class GuiText {
	...
	private float width = 0.475f;
	private float edge = 0.1f;
	
	private float borderWidth;
	private float borderEdge = 0.03f;
	 ...
	 */
	public GuiText(String text, float fontSize, FontType font, Vector2f position, float maxLineLength, boolean centered, boolean inButton) {
	...
	public GuiText(String text, float fontSize, FontType font, Vector2f position, float maxLineLength, float width, float edge, float borderWidth, float borderEdge, boolean centered, Vector3f outlineColour, Vector2f offset, boolean inButton) {
		this.textString = text;
		this.fontSize = fontSize;
		this.font = font;
		this.position = position;
	...
	public void setTextString(String textString) {
		if(!this.textString.contentEquals(textString)) {
	...
	public void setPositionWidth(double d) {
		if(this.isInButton()) {
			this.posWidth = (float)d/2;
			this.position.x -= posWidth;
