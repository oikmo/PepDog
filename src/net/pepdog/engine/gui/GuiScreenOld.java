...
import net.pepdog.engine.gui.component.old.GuiSlider;
...
public class GuiScreenOld {
	...
	public GuiScreenOld(String screenID) {
	...
	public GuiScreenOld(int textureID, String screenID) {
		this.screenID = screenID;
	...
	public GuiScreenOld(int textureID, String screenID, int tilingSize) {
		this.screenID = screenID;
		this.background = new GuiTexture(textureID, new Vector2f(0,0), new Vector2f(1,1));
		this.background.setScale(new Vector2f(1,1));
